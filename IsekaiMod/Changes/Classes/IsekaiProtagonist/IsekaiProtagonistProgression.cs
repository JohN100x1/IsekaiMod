    ...
    class IsekaiProtagonistProgression
    {
        public static void Add()
        {
            ...
            IsekaiProtagonistProgression.UIGroups = new UIGroup[] {
                Helpers.CreateUIGroup(BackstorySelection, TrainingArcSelection, NascentApotheosis, BeachEpisodeSelection, GodlyVessel, CharacterDevelopmentSelection1, ProtectiveAuraFeature, CharacterDevelopmentSelection2, GloriousAuraFeature, CharacterDevelopmentSelection3, Invincible),
