    ...
    class GloriousAuraFeature
    {
        public static void Add()
        {
            ...
            var GloriousAuraEffectBuff = Helpers.CreateBlueprint<BlueprintBuff>("GloriousAuraEffectBuff", bp => {
                ...
                bp.SetDescription("At 13th level, allies within 40 feet of the God Emporer gain a +4 competence bonus on attack {g|Encyclopedia:Dice}rolls{/g} and caster level.");
