...
namespace IsekaiMod.Changes.Features.IsekaiProtagonist.EdgeLord
{
    class EdgeLordTraining
    {
        public static void Add()
        {
            ...
            var EdgeLordTraining = Helpers.CreateBlueprint<BlueprintFeature>("EdgeLordTraining", bp => {
                bp.SetName("Fighter Training");
                bp.SetDescription("At 2nd level, the Edge Lord counts their class level as their fighter level for the purpose of qualifying for {g|Encyclopedia:Feat}feats{/g}. If they have levels in fighter, these levels stack.");
