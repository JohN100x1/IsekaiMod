...
using static IsekaiMod.Utilities.Helpers;
...
namespace IsekaiMod.Extensions
{
    static class ExtentionMethods
    {
        ...
        {
            obj.AddComponent(CreateBlueprint<PrerequisiteFeature>(bp => {
        ...
        {
            obj.AddComponent(CreateBlueprint<PrerequisiteFeaturesFromList>(c => {
        ...
        {
            obj.AddPrerequisite(CreateBlueprint(init));
        }
        ...
        {
            obj.SetComponents(obj.ComponentsArray.AddToArray(CreateBlueprint(init)));
        }
        ...
        {
            feature.SetName(CreateString(feature.name + ".Name", displayName));
        ...
        {
            var taggedDescription = DescriptionTools.TagEncyclopediaEntries(description);
            feature.m_Description = CreateString(feature.name + ".DescriptionShort", taggedDescription);
        }
        ...
        public static void AddAction(this AbilityEffectRunAction action, GameAction game_action)
        {
