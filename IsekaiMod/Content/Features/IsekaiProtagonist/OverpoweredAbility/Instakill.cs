...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.OverpoweredAbility
{
    class Instakill
    {
        ...
        private static readonly Sprite Icon_TwoHandedFighterDevastatingBlow = Resources.GetBlueprint<BlueprintFeature>("687aa977ef0d3f849af8bee2f40930df").m_Icon;
        public static void Add()
        {
            var InstakillAbility = Helpers.CreateBlueprint<BlueprintAbility>("InstakillAbility", bp => {
                bp.SetName("Overpowered Ability — Instakill");
            ...
            var InstakillFeature = Helpers.CreateFeature("InstakillFeature", bp => {
                bp.SetName("Overpowered Ability — Instakill");
                bp.SetDescription("You can kill any creature if they fail a DC 99 fortitude saving throw, otherwise they are stunned for 1 round. "
                    + "This ability bypasses death immunity.");
                bp.m_Icon = Icon_TwoHandedFighterDevastatingBlow;
