    ...
    internal class AutoSolidShadows {
        ...
        public static void Add() {
            var AutoSolidShadowsBuff = ThingsNotHandledByTTTCore.CreateBuff("AutoSolidShadowsBuff", bp => {
                bp.SetName(IsekaiContext, "Overpowered Ability — Auto Solid Shadows");
                bp.SetDescription(IsekaiContext, "Every time you cast a shadow spell, it becomes 20% more real, as though using the Solid Shadows Spell feat.");
