...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.CharacterDevelopment
{
    class IsekaiChannelPositiveEnergy
    {
        ...
        private static readonly BlueprintAbility ChannelPositiveHarm = Resources.GetBlueprint<BlueprintAbility>("279447a6bf2d3544d93a0a39c3b8e91d");
        private static readonly BlueprintAbility ChannelPositiveHeal = Resources.GetBlueprint<BlueprintAbility>("f5fc9a1a2a3c1a946a31b320d1dd31b2");
        ...
        private static readonly BlueprintFeature DeathDomainGreaterUndead = Resources.GetBlueprint<BlueprintFeature>("49bf8c679d3a7424898a5cd448e5a06b");
        ...
        public static void Add()
        {
            ...
            var IsekaiChannelPositiveEnergyAbility = Helpers.CreateBlueprint<BlueprintAbility>("IsekaiChannelPositiveEnergyAbility", bp => {
                bp.SetName("Channel Positive Energy - Damage Undead");
                bp.SetDescription("Channeling positive energy causes a burst that damages every undead creature in a 30-foot radius centered on the caster. The amount of damage "
            ...
            var IsekaiChannelPositiveHealAbility = Helpers.CreateBlueprint<BlueprintAbility>("IsekaiChannelPositiveHealAbility", bp => {
                bp.SetName("Channel Positive Energy - Heal Living");
                bp.SetDescription("Channeling positive energy causes a burst that heals every living creature in a 30-foot radius centered on the caster. The amount of damage "
            ...
            var IsekaiChannelPositiveEnergyFeature = Helpers.CreateBlueprint<BlueprintFeature>("IsekaiChannelPositiveEnergyFeature", bp => {
                ...
                bp.SetDescription("You gain the supernatural ability to channel positive energy like a cleric. You use your character level as your effective cleric level when "
                    + "channeling positive energy. This is a Charisma-based ability.");
                bp.m_Icon = ChannelPositiveHeal.Icon;
                bp.Ranks = 1;
                ...
                bp.AddComponent<AddFacts>(c => {
                    c.m_Facts = new BlueprintUnitFactReference[] {
                        ...
                        IsekaiChannelPositiveEnergyAbility.ToReference<BlueprintUnitFactReference>(),
                        IsekaiChannelPositiveHealAbility.ToReference<BlueprintUnitFactReference>()
                    };
                });
            ...
            SelectiveChannel.AddPrerequisiteFeature(IsekaiChannelPositiveEnergyFeature, Prerequisite.GroupType.Any);
            ExtraChannel.AddPrerequisiteFeature(IsekaiChannelPositiveEnergyFeature, Prerequisite.GroupType.Any);

            // Add to selection
            CharacterDevelopmentSelection.AddToSelection(IsekaiChannelPositiveEnergyFeature);
        }
    }
}
