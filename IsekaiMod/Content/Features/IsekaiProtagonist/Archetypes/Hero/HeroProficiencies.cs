    ...
    internal class HeroProficiencies {
        ...
        public static void Add() {
            var HeroProficiencies = Helpers.CreateBlueprint<BlueprintFeature>(IsekaiContext, "HeroProficiencies", bp => {
                ...
                bp.SetDescription(IsekaiContext, "The Hero is proficient with all simple and martial weapons and with all armor (heavy, light, and medium) and shields (excluding tower shields). "
