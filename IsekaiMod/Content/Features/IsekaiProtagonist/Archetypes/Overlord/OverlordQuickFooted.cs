...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.Archetypes.Overlord {
    ...
    internal class OverlordQuickFooted {
        ...
        public static void Add() {
            var OverlordQuickFooted = Helpers.CreateBlueprint<BlueprintFeature>(IsekaiContext, "OverlordQuickFooted", bp => {
                ...
                bp.SetDescription(IsekaiContext, "At 16th level, you gain a competence {g|Encyclopedia:Bonus}bonus{/g} to your {g|Encyclopedia:Initiative}initiative{/g} "
                    + "{g|Encyclopedia:Check}checks{/g} equal to your {g|Encyclopedia:Strength}Strength{/g} modifier.");
