...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.Archetypes.EdgeLord
{
    class EdgeLordProficiencies
    {
        ...
        {
            var EdgeLordProficiencies = Helpers.CreateBlueprint<BlueprintFeature>("EdgeLordProficiencies", bp => {
                bp.SetName("Edge Lord Proficiencies");
                bp.SetDescription("The Edge Lord is proficient with all simple and martial weapons as well as light and medium armor. They can cast {g|Encyclopedia:Spell}spells{/g} from this class while wearing armor without incurring the normal {g|Encyclopedia:Spell_Fail_Chance}arcane spell failure chance{/g}, but they incur the normal arcane spell failure chance for arcane spells received from other classes.");
                bp.m_Icon = null;
