...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.Archetypes.Mastermind {
    ...
    internal class GodEmperorQuickFooted {
        ...
        public static void Add() {
            var GodEmperorQuickFooted = Helpers.CreateBlueprint<BlueprintFeature>(IsekaiContext, "GodEmperorQuickFooted", bp => {
                ...
                bp.SetDescription(IsekaiContext, "At 15th level, you gain a competence {g|Encyclopedia:Bonus}bonus{/g} to your {g|Encyclopedia:Initiative}initiative{/g} "
                    + "{g|Encyclopedia:Check}checks{/g} equal to your {g|Encyclopedia:Wisdom}Wisdom{/g} modifier.");
