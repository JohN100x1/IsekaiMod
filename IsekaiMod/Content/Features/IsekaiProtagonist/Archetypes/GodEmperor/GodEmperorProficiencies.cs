...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.Archetypes.GodEmperor
{
    class GodEmperorProficiencies
    {
        ...
        public static void Add()
        {
            ...
            var GodEmperorProficiencies = Helpers.CreateFeature("GodEmperorProficiencies", bp => {
                bp.SetName("God Emperor Proficiences");
                bp.SetDescription("The God Emperor is proficient with all simple, martial, and exotic weapons and with all armor (heavy, light, and medium) and shields "
