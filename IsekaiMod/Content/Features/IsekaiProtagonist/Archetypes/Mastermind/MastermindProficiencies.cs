    ...
    internal class MastermindProficiencies {
        ...
        public static void Add() {
            ...
            var MastermindProficiencies = Helpers.CreateBlueprint<BlueprintFeature>(IsekaiContext, "MastermindProficiencies", bp => {
                ...
                bp.SetDescription(IsekaiContext, "The Mastermind is proficient with all simple, martial, and exotic weapons and with all armor (heavy, light, and medium) and shields "
