    ...
    internal class IsekaiChannelNegativeEnergy {
        ...
        public static void Add() {
            ...
            var Feature = Helpers.CreateBlueprint<BlueprintFeature>(IsekaiContext, "IsekaiChannelNegativeEnergyFeature", bp => {
                ...
                bp.SetDescription(IsekaiContext, "You gain the supernatural ability to channel negative energy like a cleric. You use your Isekai Protagonist level as your effective cleric level when "
