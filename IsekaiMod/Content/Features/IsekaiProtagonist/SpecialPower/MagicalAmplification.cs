...
namespace IsekaiMod.Content.Features.IsekaiProtagonist.SpecialPower {
    ...
    internal class MagicalAmplification {
        public static void Add() {
            LocalizedString MagicalAmplificationDesc = Helpers.CreateString(IsekaiContext, "MagicalAmplification.Description",
                "Any {g|Encyclopedia:Spell}spells{/g} dealing {g|Encyclopedia:Damage}damage{/g} now change their dice to d10, "
